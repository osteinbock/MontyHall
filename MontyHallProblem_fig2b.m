...
function dydt = odefun_full(~, y, k1, k2, ksw, kst)
    ...
    % dI_{j,k,ℓ} (switch products) – here zero because ksw=0
    dI231 = ksw*I23*D1;
    dI321 = ksw*I32*D1;
    dI123 = ksw*I12*D3;
    dI132 = ksw*I13*D2;
...
function plotResults(t,y)
    ...
    legend('Player species P','Stay wins','Stage-1 intermediates ', ...
        'Stage-2 intermediates', 'Stay losses','Location','northeast', ...
